                ...
                <div>
                    <div class="center">
                        ...
                        <#list offices.content as office>
                            <a href="/client/office/profile/${office.id}"><p>${office.city} ${office.street}</p></a>
                        </#list>

                        <nav>
                            <ul class="pager">
                            <#if page == 0>
                                <li><a href="/client/offices/0">Previous</a></li>
                            <#else>
                                <li><a href="/client/offices/${page - 1}">Previous</a></li>
                            </#if>
                                <li><a href="/client/offices/${page + 1}">Next</a></li>
                            </ul>
                        </nav>
